...
a persistence unit "companyprojPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "companyproj/pom.xml":
...
artifacts ("companyproj-ejb.jar" and "companyproj-web.war") are already built. You can build
